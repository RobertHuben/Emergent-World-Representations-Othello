...
if __name__=="__main__":
    ...
    #leaky_topk_training_sweep(k_list=[65, 70, 75, 80, 85, 90, 95, 100, 105, 110], epsilon_list=[0.005, 0.01, 0.05, 0.1, 0], mode_list=["absolute"])
    gated_training_sweep([0.5, 0.75, 1, 1.5, 2, 2.5], ["standard"])